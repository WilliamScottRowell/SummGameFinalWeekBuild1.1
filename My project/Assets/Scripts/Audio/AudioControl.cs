...
namespace CMF
{
    ...
    public class AudioControl : MonoBehaviour
    {
        ...
        public AudioClip footStepSnowClip;
        public AudioClip footStepSewerClip;
        ...
        void PlayFootstepSound(float _movementSpeed)
        {
            ...
            {
                audioSource.PlayOneShot(footStepSnowClip, audioClipVolume + audioClipVolume * Random.Range(-relativeRandomizedVolumeRange, relativeRandomizedVolumeRange));
            }
            else if (currentSurface == "sewer")
            {
                audioSource.PlayOneShot(footStepSewerClip, audioClipVolume + audioClipVolume * Random.Range(-relativeRandomizedVolumeRange, relativeRandomizedVolumeRange));
            }
            else if (currentSurface == "grass")
            {
                audioSource.PlayOneShot(footStepGrassClip, audioClipVolume + audioClipVolume * Random.Range(-relativeRandomizedVolumeRange, relativeRandomizedVolumeRange));
            }
